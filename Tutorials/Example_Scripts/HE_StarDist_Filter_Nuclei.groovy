...
def modelPath = $/\\ad.helsinki.fi\home\g\gkristin\Desktop\StarDistModels\he_heavy_augment.pb/$
...
// Classifier to identify real and false nuclei by classifing them
runObjectClassifier("Nuclei_filter")

// Remove the false detections
def toDelete = getDetectionObjects().findAll {it.getPathClass() == getPathClass('FalseNuclei')}
